try{
	...
	client.on('ready', () => { 
		...
		bot.on('ready', () => {
			...
			console.log(colors.cyan('\__$$  __|           \__|  $$ |    $$ |                              '))
			console.log(colors.cyan('   $$ |$$\  $$\  $$\ $$\ $$$$$$\ $$$$$$\    $$$$$$\   $$$$$$\        '))
			console.log(colors.cyan('   $$ |$$ | $$ | $$ |$$ |\_$$  _|\_$$  _|  $$  __$$\ $$  __$$\       '))
			console.log(colors.cyan('   $$ |$$ | $$ | $$ |$$ |  $$ |    $$ |    $$$$$$$$ |$$ |  \__|      '))
			console.log(colors.cyan('   $$ |$$ | $$ | $$ |$$ |  $$ |$$\ $$ |$$\ $$   ____|$$ |            '))
			console.log(colors.cyan('   $$ |\$$$$$\$$$$  |$$ |  \$$$$  |\$$$$  |\$$$$$$$\ $$ |            '))
			console.log(colors.cyan('   \__| \_____\____/ \__|   \____/  \____/  \_______|\__|            '))
		  });
